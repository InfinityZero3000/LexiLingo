...
\midrule
\endhead
CAG thuần & 59,4\% & 71,3\% & 47,7\% & 1,38 s\\
\textbf{TRACE-CAG} & \textbf{62,5\%} & \textbf{74,7\%} & 48,4\% & 1,38 s\\
HippoRAG~2 (bản chính thức) & 48,4--50,0\% & 59,3--64,2\% & không có & $\approx$64 s\\
\bottomrule
\caption{So sánh trên HotpotQA, n=64, cùng mô hình đọc}
\end{longtable}

Con số HippoRAG là \textbf{khoảng giá trị qua hai lần chạy cùng cấu hình}, phản ánh
phương sai thật của thiết lập này ($\pm$1,6 EM / $\pm$4,9 F1 ở n=64): mô hình hoặc
trả lời gọn 1--3 từ, hoặc đổ ra 150--180 từ lập luận, và 8/64 câu đổi giữa hai kiểu
đó giữa các lần chạy. Không nên trích dẫn một đầu của khoảng.
