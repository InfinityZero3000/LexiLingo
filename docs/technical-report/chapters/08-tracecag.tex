...
\begin{luuy}[Kết quả benchmark trên bộ đánh giá đa bước nội bộ]
Cấu hình tốt nhất đo được (bật IRCoT mặc định, giữ đệm L0/L1) đạt \textbf{Exact Match
50,0\% / F1 62,5\%} — bằng EM và vượt F1 so với đường cơ sở HippoRAG trên cùng bộ dữ liệu.
...
mô hình mạnh/yếu). Bốn lần thử tối ưu khác (trọng số đồ thị, đơn giản hoá E2G, đổi sang mô
hình 70B) đều \textbf{làm giảm} chất lượng và bị hoàn tác trước khi IRCoT được áp dụng.
\end{luuy}
