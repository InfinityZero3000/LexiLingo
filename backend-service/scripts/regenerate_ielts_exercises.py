...
SKILL_BRIEF = {
    ...
    "reading": (
        ...
        "prose first, then the question as the LAST sentence, ending in a question "
        "mark. The app splits on that final question mark and shows the prose as the "
        "passage, so the split fails if the last sentence is not a question.\n"
