...
async def proxy_image(url: str = Query(..., description="The image URL to proxy")):
    ...
    # safe_get validates scheme/host, resolves+pins the connection to a public
    # IP, and repeats that validation on every redirect hop (see
    # app/core/safe_http.py) — a plain httpx follow_redirects=True here would
