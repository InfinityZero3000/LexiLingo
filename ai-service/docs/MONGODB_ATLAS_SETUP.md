...
5. **Copy connection string**:
   ```
   mongodb+srv://lexilingo_user:<password>@lexilingo-cluster.xxxxx.mongodb.net/?retryWrites=true&w=majority
   ```

6. **Replace** `<password>` with your actual password:
   ```bash
   # Example (DON'T use this, use your own!)
   mongodb+srv://lexilingo_user:Xy9mK3pL7nQ2rT8vW4jF@lexilingo-cluster.ab12c.mongodb.net/?retryWrites=true&w=majority
   ```
...
```bash
# .env
MONGODB_ATLAS_URI=mongodb+srv://lexilingo_user:YOUR_PASSWORD@lexilingo-cluster.xxxxx.mongodb.net/?retryWrites=true&w=majority
```
...
2. **Environment Variables** → **Add New**
   ...
   Value: mongodb+srv://lexilingo_user:YOUR_PASSWORD@...
   ```
...
export MONGODB_ATLAS_URI="mongodb+srv://lexilingo_user:YOUR_PASSWORD@..."
...
# Connect
mongosh "mongodb+srv://lexilingo_user:YOUR_PASSWORD@..."
